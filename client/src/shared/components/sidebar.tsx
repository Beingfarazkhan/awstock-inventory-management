...
import AWStockLogo from "../../assets/awstocklogo.png"
...
const Sidebar = () => {
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            ><Link className="flex flex-row gap-3 justify-between md:justify-normal items-center" href={"/"}>
                    <Image
                        src={AWStockLogo}
                        alt="awstock-logo"
                        width={27}
            ...
            <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
                <p className="text-center text-xs text-gray-500">&copy; 2024 AWStock</p>
            </div>
        </div>
    );
};
